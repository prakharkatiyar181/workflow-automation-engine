...
const Select = forwardRef<HTMLSelectElement, SelectProps>(
  ({ label, error, helperText, icon, disabled, required, className, children, ...props }, ref) => {
    return (
      <div className={clsx("w-full space-y-1.5", className)}>
        ...
        <div className="relative">
          ...
          <select
            ...
            required={required}
            className={clsx(
              "block w-full rounded-lg bg-gray-900 border text-sm text-gray-100 appearance-none",
